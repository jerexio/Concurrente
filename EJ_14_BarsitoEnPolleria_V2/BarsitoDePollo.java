...
public class BarsitoDePollo {
    ...
    public static void main(String[] args){
        ...
        Confiteria[] sillas = {new Confiteria(), new Confiteria()};
        Thread[] empleados = new Thread[6];
        Cocinero cocinero1 = new Cocinero(sillas[0]);
        Cocinero cocinero2 = new Cocinero(sillas[1]);
        Mozo mozo = new Mozo(sillas);
        ...
        for(int i = 0; i < 6; i++){
            Empleado emp = new Empleado(sillas);
